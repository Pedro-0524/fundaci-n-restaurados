import 'package:authentification/page/pages/Quiz/src/controller/question.dart';
            ...
            children: <Widget>[
              ...
              Padding(
                ...
                child: Obx(
                  () => Text.rich(
                    TextSpan(
                      text: "Preguntas ${_controller.questionNumber.value}",
...
IconData getIcon(QuestionController controller, int index) {
  return getColor(controller, index) == Colors.grey ? Icons.check : Icons.done;
}
